...
plt.pie(ab_counts.first_name.values, labels=['A (Fitness Test)','B (No Fitness Test)'], autopct='%0.2f%%')
plt.axis('equal')
...
print (pval)
#reject null hypothesis, results are significantly different
...
print (pval)
#cannot reject null hypothesis, results are not significantly different
...
ax.set_yticks([0, 0.02, 0.04, 0.06, 0.08, 0.10, 0.12, 0.14, 0.16])
